...
export default function MarketingPage() {
  ...
  // IntersectionObserver → which slide is currently in view?
  React.useEffect(() => {
  ...
  // Optional: up/down keys to navigate slides
  React.useEffect(() => {
  ...
  return (
    <div className="relative h-screen bg-black text-white">
      ...
      {/* DOT / LABEL NAV ON THE RIGHT */}
      <div className="pointer-events-none fixed inset-y-0 right-6 z-40 flex items-center">
            ...
            return (
              <button
                ...
                className={`
                  ...
                  ${
                    isActive
                      ? "border-[#B9A8FF] bg-[#B9A8FF] text-black"
                      : "border-white/20 bg-black/40 text-white/60 hover:border-white/60 hover:text-white"
                  }
                `}
              >
                <span
